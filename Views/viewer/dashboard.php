...
<div class="w3-bg-image">
	...
	<div class="w3-row-padding w3-margin-bottom">
		<div class="w3-quarter">
			<div class="w3-container w3-padding-16 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color w3-icon fa fa-lightbulb-o" style="font-size:30px"></i>
					<i class="w3-icon-color w3-icon fa fa-lightbulb-o" style="font-size:45px"></i>
					<i class="w3-icon-color w3-icon fa fa-lightbulb-o" style="font-size:60px"></i></div>
        <div class=" w3-right">
						<h3>
							<?php
							$all = "0";
		...
		<div class="w3-quarter">
			<div class="w3-container w3-teal w3-padding-16 m8-fancy w3-black">
				<div class="w3-left"><i class="fa fa-lightbulb-o w3-xxxlarge"style="color: orangered;"></i></div>
				<div class="w3-right">
		...
		<div class="w3-quarter">
			<div class="w3-container w3-orange w3-padding-16 m8-fancy w3-black w3-blue">
				<div class="w3-left"><i class="w3-icon-color fa fa-plug w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h5>
					<?php
					$pwr = "0";
	...
	<div class="w3-row-padding w3-margin-bottom">
		<div class="w3-quarter w3-button0" onclick0="window.location.assign('?item=2')">
			<div class="w3-container w3-indigo w3-padding-16 w3-hover-red0 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color fa fa-user w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h3>
						<?php
						if ($branch == 6) {
		...
		<div class="w3-quarter">
			<div class="w3-container w3-purple w3-padding-16 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color fa fa-user-o w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h3>
						<?php
						if ($branch == 6)
		...
		<div class="w3-quarter">
			<div class="w3-container w3-green w3-padding-16 m8-fancy w3-black w3-blue">
				<div class="w3-left"><i class="w3-icon-color fa fa-user-secret w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h3>
						<?php
						if ($branch == 6)
		...
		<div class="w3-quarter">
			<div class="w3-container w3-deep-orange w3-padding-16 m8-fancy w3-black w3-blue">
				<div class="w3-left"><i class=" w3-icon-color fa fa-users w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h3>
						<?php
						if ($branch == 6)
	...
	<div class="w3-section w3-container">
		<div class="w3-card w3-padding w3-row w3-center m8-fancy w3-black">
			<div class="w3-third w3-mobile w3-animate-zoom-x"><img src="../img/co2.jpg" style="height:100px"></div>
