...
<div class="w3-bg-image">
	...
	<div class="w3-row-padding w3-margin-bottom">
		...
		<div class="w3-quarter" onclick="window.location.assign('?item=7')">
			<div class="w3-container w3-red w3-padding-16 m8-fancy w3-black">
	...
	<div class="w3-row-padding w3-margin-bottom">
		<div class="w3-quarter w3-button0" onclick0="window.location.assign('?item=2')">
			<div class="w3-container w3-indigo w3-padding-16 m8-fancy w3-black">
		...
		<div class="w3-quarter">
			<div class="w3-container w3-purple w3-padding-16 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color fa fa-user-o w3-xxxlarge"></i></i></div>
				<div class="w3-right">
					<h3>
						<?php
						$blockArr = array();
	...
	<div class="w3-section w3-container">
		<div class="w3-card w3-black w3-padding w3-row w3-center m8-fancy">
