	...
	<div class="w3-row-padding w3-margin-bottom">
		...
		<div class="w3-quarter">
			<div class="w3-container w3-orange w3-padding-16 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color w3-icon fa fa-plug w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h3>
						<?php
						$pwr = "0";
	...
	<div class="w3-row-padding w3-margin-bottom">
		<div class="w3-quarter w3-button0" onclick0="window.location.assign('?item=2')">
			<div class="w3-container w3-indigo w3-padding-16 w3-hover-red0 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color w3-icon fa fa-user w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h3>
						<?php
		...
		<div class="w3-quarter">
			<div class="w3-container w3-purple w3-padding-16 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color w3-icon fa fa-user-o w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h3>
						<?php
		...
		<div class="w3-quarter">
			<div class="w3-container w3-green w3-padding-16 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color w3-icon fa fa-user-secret w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h3>
						<?php
		...
		<div class="w3-quarter">
			<div class="w3-container w3-deep-orange w3-padding-16 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color w3-icon fa fa-users w3-xxxlarge"></i></div>
				<div class="w3-right">
					<h3>
						<?php
	...
	<table id="id01" class="w3-table-all m8-fancy" style="overflow-y:scroll; overflow-x:scroll; height:400px;">
		<thead>
			<tr class="w3-color">
				...
				<th>Cumulative Harvested Energy(KWH)</th>
...
<script>
	...
	function drawChart() {
		...
		var options = {
			...
			colors: ['#107090', '#e6693e', '#ec8f6e', '#f3b49f', '#f6c7b6']
		};
