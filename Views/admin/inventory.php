...
<div class="w3-quarter" style="overflow-y: scroll;height:346px;overflow-x:hidden;margin-left:10px;" id="InvData">
    <div class="w3-bar w3-card w3-button m8-fancy" style="margin-bottom:10px; background-color:#aad6ed" w3-repeat="result">
...
<div class="" style="display:none; float: right; width:72%;" id="txtHint">
    <div class="w3-container">
        <div id="txtResult">
            <div class="w3-card w3-white w3-margin-bottom w3-row m8-fancy" style="border: 3px solid #aad6ed;height:346px;">
    ...
    <div class="w3-modal-content w3-animate-top w3-card-4" id="reShape" style="width:400px; height:275px">
        ...
        <div class="w3-padding">
            ...
            <div id="uploadCsv">
                ...
                <button id="buttonClear" onclick="clearFileInput()" style="background-color: #08689b;color:white;display:none">X</button>
            </div>
