...
<!---favicon start--->
<link rel="apple-touch-icon-precomposed" href="../img/favicons1.png" />
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="../img/favicons1.png" />
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="../img/favicons1.png" />
<link rel="shortcut icon" href="../img/favicons1.png">
<!---favicon stop--->

<style>
html,body,h1,h2,h3,h4,h5,h6,h7 {font-family: "Raleway", sans-serif}
.w3-color, .w3-hover-color:hover{color: #fff!important;background-color: #4B54AD!important;}
.w3-text-color, .w3-hover-text-color:hover {color: #4B54AD!important;}
...
<div class="w3-bar w3-top w3-large w3-card-4" style="z-index:4;background-color:#fff;color:#fff;">
  ...
  <img src="../img/hqlogo2.png" class="w3-bar-item w3-hide-small">
  <span class="w3-bar-item w3-hide-small" style="background-color:#4B54AD;;height:61px;padding-top:15px;"><b><?php echo $project_name; ?></b></span>
  <span class="w3-bar-item w3-hide-medium w3-hide-large" style="background-color:#4B54AD;;height:61px;padding-top:15px;"><b>Surya RMS</b></span>
  <!-- <img src="../img/line.png" style="height:61px;"> -->  
  <a href="../Controller/logout.php" class="w3-right w3-text-color w3-light-graiiy w3-button w3-hide-small" style="padding:17px;" title="Logout"><i class="fa fa-sign-out fa-fw"></i></a>
  <span class="w3-hide-small w3-right w3-large w3-margin-left w3-margin-right" style="margin-top:17px;color:#4B54AD;;"><span>Welcome, <strong><?php echo $name; ?></strong></span></span>
